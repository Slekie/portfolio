    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 flex flex-col z-30">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <a
            href="/"
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all"
          >
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6">
        <h3 className="font-semibold text-sm text-zinc-500 dark:text-zinc-400 uppercase tracking-wider mb-4">Quick Actions</h3>
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-indigo-500/50 hover:text-indigo-500 transition-all text-sm font-medium text-zinc-600 dark:text-zinc-400 group"
            >
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-zinc-400">{messages.filter(m => !m.read).length} unread</p>
        </div>
        <button
          onClick={onRefresh}
          className="px-4 py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 text-sm font-medium hover:border-indigo-500 hover:text-indigo-500 transition-all"
        >
          Refresh
        </button>
      </div>
          ...
          <div className="space-y-2">
            {messages.map((msg) => (
              ...
              >
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400 line-clamp-2">{msg.message}</p>
              </button>
            ))}
          </div>
          ...
          <div className="sticky top-24">
            {selected ? (
              ...
              >
                ...
                <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800 text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed mb-4">
                  {selected.message}
                </div>
